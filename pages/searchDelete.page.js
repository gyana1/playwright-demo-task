...
exports.SearchDeletePage = void 0;
var SearchDeletePage = /** @class */ (function () {
    function SearchDeletePage(page) {
        this.page = page;
    ...
    SearchDeletePage.prototype.searchDeleteLocation = function (searchLocal, searchTerm) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        _a.sent();
                        return [4 /*yield*/, this.page.waitForSelector('.Location_locationDetailsContainer__z2qZP')];
                    case 6:
                        _a.sent();
                        return [4 /*yield*/, this.deleteBtn.click()];
                    case 7:
                        _a.sent();
                        return [4 /*yield*/, this.confirmDialog.isVisible({ timeout: 3000 })];
                    case 8:
                        _a.sent();
                        return [4 /*yield*/, this.okBtn.click()];
                    case 9:
                        _a.sent();
                        return [4 /*yield*/, this.page.waitForTimeout(3000)];
                    case 10:
    ...
    return SearchDeletePage;
}());
exports.SearchDeletePage = SearchDeletePage;
//# sourceMappingURL=searchDelete.page.js.map